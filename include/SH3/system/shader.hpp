...
public:
	 ...
	 */
	template<typename ... T>
	GLint SetUniform(const std::string& name, T ... args);
	 ...
	 */
	GLint GetAttribLocation(const std::string& name){return glGetAttribLocation(programID, name.c_str());};
...
private:
	...
	std::vector<ShaderAttribute> 	attribs;	/**< Attributes list */
};
